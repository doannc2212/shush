...
<div class="panel">
  ...
  <div class="steps">
    <div class="step">
      ...
      <div>
        ...
        {:else}
          ...
          <p class="step-body">
            Select a preset duration (<strong>5m</strong>, <strong>15m</strong>,
            <strong>30m</strong>,
            <strong>1h</strong>, <strong>2h</strong>) or <strong>∞</strong> to mute the active tab
            immediately.
          </p>
        {/if}
      </div>
      ...
      <div>
        {#if casual}
          ...
          <p class="step-body">
            ...
            silenced → hit the button to apply. Already-muted tabs are greyed out — you can't
            double-mute them, we checked.
          </p>
        {:else}
          <p class="step-title">Mute specific tabs</p>
          <p class="step-body">
            In the <strong>Mute tabs</strong> view, select a duration, check the tabs to mute, then
            confirm. Already-muted tabs are disabled.
          </p>
        {/if}
      </div>
    </div>
      ...
      <div>
        {#if casual}
          ...
          <p class="step-body">
            ...
            <strong>Let it speak</strong>
            any time to restore audio early.
          </p>
        {:else}
          <p class="step-title">Active mutes</p>
          <p class="step-body">
            The <strong>Active</strong> view lists all muted tabs with expiry countdowns. Click
            <strong>Let it speak</strong>
            to restore audio before the timer ends.
          </p>
        {/if}
      </div>
    </div>
    ...
    <div class="tip">
      ...
      {:else}
        <p>
          Tabs can be muted before audio starts. The mute persists when audio begins, blocking
          autoplay.
        </p>
      {/if}
    </div>
